# Phase 0 — Environment audit (Gate 0)
...
| criterion | result |
|---|---|
| 0.1_reproducibility_audit | PASS |
| 0.2_latent_roundtrip | PASS |
| 0.3_persistence | PASS |
| 0.4_latent_geometry | PASS |
| 0.5_generation_health | PASS |
| 0.6_native_channel | PASS |
...
```json
{
  ...
  "0.4_latent_geometry": {
    ...
    "z_mean": 0.0005764622474089265,
    "z_std": 1.002151370048523,
    "z_dtype_rounded_to": "float16"
  },
  "0.2_latent_roundtrip": {
    "pass": true,
  ...
  "0.3_persistence": {
    "pass": true,
    "path": "/ssd2/ming/FIBER/gate0/z_roundtrip.pt",
    "bit_exact": true,
    "bytes": 525488
  },
  "0.5_generation_health": {
    "pass": true,
    "samples": 100,
    "non_finite_values": 0,
    "grad_enabled_in_output": false,
    "seconds_total": 125.8,
    "seconds_per_image": 1.26,
    "guidance_scale": 3.0
  },
  "0.1_reproducibility_audit": {
    "pass": true,
    "pairs": 8,
    "bit_identical_pairs": 8,
    "psnr_min": Infinity,
    "psnr_mean_finite": null,
    "psnr_all_infinite": true,
